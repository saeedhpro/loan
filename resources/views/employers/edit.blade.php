<x-app-layout>
    ...
    <div class="overflow-x-auto mb-6">
        ...
        @endif
        <form id="create-employer" method="POST" action="{{ route('dashboard.employers.update', ['id' => $user->id]) }}" class="flex flex-col mt-6 space-y-6 px-6">
            @method('put')
            {{ csrf_field() }}
            ...
            <div class="flex">
                <div class="w-full md:w-1/2 px-1">
                    ...
                    <x-select-input :options="$roles" id="role" name="role" type="text" class="mt-1 block w-full" :value="old('role', $user->role)" required autocomplete="role" />
                                ...
                                <div class="form-control">
                                    <label class="cursor-pointer label">
                                        <input type="checkbox"
                                               ...
                                               @if(is_array($user->permission_id_list) && in_array($o->id, $user->permission_id_list)) checked @endif
                                        />
